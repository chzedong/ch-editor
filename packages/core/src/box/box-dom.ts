 ...
 */
export function createBoxWrapper(boxData: BoxData, content: HTMLElement, canWrap: boolean = false): HTMLElement {
 ...
 */
export function isBoxWrapper(element: Element): boolean {
 ...
 * @param element DOM 元素
 */
export function isBoxContent(element: Element): boolean {
 ...
 */
export function getBoxId(boxElement: Element): string | null {
 ...
 * @param boxElement box 包装器元素
 */
export function getBoxType(boxElement: Element): string | null {
 ...
 * @param boxElement box 包装器元素
 */
export function canBoxWrap(boxElement: Element): boolean {
 ...
 * @param boxElement box 包装器元素
 */
export function getBoxContent(boxElement: Element): Element | null {
